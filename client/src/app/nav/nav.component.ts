...
@Component({
  ...
  `,
  styles: [`
    nav { align-items:center; background:var(--surface); border-bottom:1px solid var(--border); display:flex; gap:12px; height:58px; padding:0 28px; position:sticky; top:0; z-index:50; }
